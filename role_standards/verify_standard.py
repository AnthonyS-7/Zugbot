...
#     """
#     def __init__(self, verifier_function: Callable[[player.Player, ability.Ability, game_state.GameState, list, list], tuple[bool, str]]) -> None:
#         """
...
#     def verify(self, player_using_action: player.Player, ability_being_used: ability.Ability, gamestate: game_state.GameState,
...
# def _no_self_target_verifying_function(player_object: 'player.Player', ability_object: 'ability.Ability',
...
# def _night_only(player_object: 'player.Player', ability_object: 'ability.Ability',
#                    gamestate: game_state.GameState, formal_parameters: list, actual_parameters: list) -> tuple[bool, str]:
#     requirement = "It must be night to do this."
#     return (not gamestate.is_day, requirement)
# def _day_only(player_object: 'player.Player', ability_object: 'ability.Ability',
#                    gamestate: game_state.GameState, formal_parameters: list, actual_parameters: list) -> tuple[bool, str]:
#     requirement = "It must be day to do this."
#     return (gamestate.is_day, requirement)
# def _even_cycle(player_object: 'player.Player', ability_object: 'ability.Ability',
#                    gamestate: game_state.GameState, formal_parameters: list, actual_parameters: list) -> tuple[bool, str]:
#     return (gamestate.phase_count % 2 == 0, 'It must be an even cycle to do this.')
# def _odd_cycle(player_object: 'player.Player', ability_object: 'ability.Ability',
#                    gamestate: game_state.GameState, formal_parameters: list, actual_parameters: list) -> tuple[bool, str]:
#     return (gamestate.phase_count % 2 == 1, 'It must be an odd cycle to do this.')
# def _disloyal_for_mafia(player_object: 'player.Player', ability_object: 'ability.Ability',
#                    gamestate: game_state.GameState, formal_parameters: list, actual_parameters: list) -> tuple[bool, str]:
